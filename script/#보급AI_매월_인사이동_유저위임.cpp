	...
	for (int i = 0; i < 건물_도시끝; i++)
	{
	     ...
	     pk::building@ base  = pk::get_building(i);
            ...
            int enemy_weight = countNeighborEnemyBase(base);
             ...
             if (base.get_district_id() == district_id and (1 <= func_enemy_city_count(city_a, 1) or 0 < enemy_weight) and 6000 <= pk::get_troops(base))
        ...
        bool PushValor(pk::building@ dst_base)
        {
            ...
            // 미행동 무장리스트
	    pk::district@ district = pk::get_district( dst_base.get_district_id());
	...
	for (int i = 0; i < 건물_도시끝; i++)
	{
	     ...
	     pk::building@ base  = pk::get_building(i);
           ...
           if (0 < b_list.length)
            {
                for (int i = 0; i < int(b_list.length); i++)
                {
                    pk::person@ person = b_list[i];
                             ...
                             if (b_list[i].stat[무장능력_무력] >= 86 and !b_list[i].action_done   and b_list[i].get_district_id() == dst_base.get_district_id() )
           ...
           if (0 < c_list.length)
            ...
            if (c_list[i].get_district_id() != dst_base.get_district_id()) continue; 
            ...
            if (c_list[i].mibun == 신분_재야) continue;
                   ...
                   if (!pk::is_unitize(c_list[i]) and !pk::is_absent(c_list[i]) and c_list[i].order == -1 and c_list[i].service != dst_base.get_id() and c_list[i].location != dst_base.get_id() and c_list[i].stat[무장능력_무력] >= 86 and c_list[i].location == c_list[i].service and !c_list[i].action_done and !pk::is_absent(c_list[i]) and (c_list[i].mibun == 신분_도독 or c_list[i].mibun == 신분_태수 or c_list[i].mibun == 신분_일반) and c_list[i].get_district_id() == src_base.get_district_id() and c_list[i].get_district_id() == dst_base.get_district_id() and 0 == func_enemy_city_count(city_b, 1))
                      {
	     ...
	     pk::building@ base  = pk::get_building(i);
           ...
           if (0 < b_list.length)
            {
                for (int i = 0; i < int(b_list.length); i++)
                {
                    pk::person@ person = b_list[i];
                             ...
                             if (b_list[i].stat[무장능력_지력] >= 86 and !b_list[i].action_done   and b_list[i].get_district_id() == dst_base.get_district_id() )
           ...
           if (0 < c_list.length)
            ...
            if (c_list[i].mibun == 신분_재야) continue;
                      ...
                      if (!pk::is_unitize(c_list[i]) and !pk::is_absent(c_list[i]) and c_list[i].order == -1 and c_list[i].service != dst_base.get_id() and c_list[i].location != dst_base.get_id() and c_list[i].stat[무장능력_지력] >= 86 and c_list[i].location == c_list[i].service and !c_list[i].action_done and !pk::is_absent(c_list[i]) and (c_list[i].mibun == 신분_도독 or c_list[i].mibun == 신분_태수 or c_list[i].mibun == 신분_일반) and c_list[i].get_district_id() == src_base.get_district_id() and c_list[i].get_district_id() == dst_base.get_district_id() and 0 == func_enemy_city_count(city_b, 1))
                      {

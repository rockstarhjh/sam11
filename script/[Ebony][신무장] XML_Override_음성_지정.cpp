	...
	class Main
	{
		...
		void xml()
		{
			...
			*/
			...
			<!--황예린--><무장 번호="963"><음성 값="초선"/></무장>
			<무장 번호="964"><음성 값="초선"/></무장>
			<무장 번호="965"><음성 값="채염"/></무장>
			<무장 번호="966"><음성 값="위엄녀"/></무장>
			<무장 번호="967"><음성 값="대담녀"/></무장>
			<무장 번호="968"><음성 값="왕이"/></무장>
			<무장 번호="969"><음성 값="왕이"/></무장>
			<무장 번호="970"><음성 값="견씨"/></무장>
			<무장 번호="971"><음성 값="냉정녀"/></무장>
			<무장 번호="972"><음성 값="냉정녀"/></무장>
			<무장 번호="973"><음성 값="냉정녀"/></무장>
			<무장 번호="974"><음성 값="냉정녀"/></무장>
			<무장 번호="975"><음성 값="냉정녀"/></무장>
			<무장 번호="976"><음성 값="보통녀"/></무장>
			<무장 번호="977"><음성 값="보통녀"/></무장>
			<무장 번호="978"><음성 값="보통녀"/></무장>
			<무장 번호="979"><음성 값="보통녀"/></무장>
			<무장 번호="980"><음성 값="요염녀"/></무장>
			<무장 번호="981"><음성 값="요염녀"/></무장>
			<무장 번호="982"><음성 값="요염녀"/></무장>
			<무장 번호="983"><음성 값="요염녀"/></무장>
